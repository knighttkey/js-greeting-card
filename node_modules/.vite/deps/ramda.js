...
var partialObject_default = _curry2((f, o3) => (props3) => f.call(void 0, mergeDeepRight_default(o3, props3)));
...
var _xpromap = _curry3(function _xpromap2(f, g, xf) {
...
var promap = _curry3(
  _dispatchable(["fantasy-land/promap", "promap"], xpromap_default, _promap)
);
...
var _xuniqWith = _curry2(function _xuniqWith2(pred, xf) {
...
var uniqWith = _curry2(
  _dispatchable([], xuniqWith_default, function(pred, list) {
    var idx = 0;
    var len = list.length;
    var result = [];
    var item;
